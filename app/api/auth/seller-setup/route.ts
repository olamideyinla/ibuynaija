/**
 * POST /api/auth/seller-setup
 * Submits a seller application right after registration (account_type = seller).
 * Does NOT create a sellers record — an admin must approve it first via
 * /admin/seller-applications, same as the /account "Become a Seller" path.
 */
